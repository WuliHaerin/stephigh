...
public class GameManager : MonoBehaviour
{
    ...
    [HideInInspector]
    public ulong giftTime, adsTime; //to save the time at which the gift button was clicked
    #endregion
...
class GameData
{
    ...
    private ulong giftTime, adsTime; //to save the time at which the gift button was clicked
